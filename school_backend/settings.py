...
SECRET_KEY = 'django-insecure-g3@kb@d98g^cw)5$=fh#=u8zopurw4rt&!v$#itg%scx61fevn'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'School Site API',
    'DESCRIPTION': 'Учителя, отзывы, контакты школы, документы (загрузка/скачивание).',
    'VERSION': '1.0.0',
}
